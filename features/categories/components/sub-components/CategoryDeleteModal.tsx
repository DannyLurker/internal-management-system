          ...
          >
            ...
            <div className="mx-6 mb-6 rounded-lg bg-[#eef4ff]/80 px-4 py-4 text-center">
              <p className="font-ochre-ui text-sm leading-relaxed text-[#524439]">
                ...
                <span className="font-semibold text-[#121c28]">{categoryName}</span>{" "}
                category. This action is{" "}
                <span className="font-semibold text-[#ba1a1a]">irreversible</span>{" "}
                and will detach{" "}
                <span className="font-semibold text-[#121c28]">{itemCount}</span>{" "}
                {itemCount === 1 ? "item" : "items"} from their classification.
              </p>
            </div>
