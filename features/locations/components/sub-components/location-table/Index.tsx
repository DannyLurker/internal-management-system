  ...
  if (isError) {
    return (
      <div
        ...
        role="alert"
      >
        Something went wrong while loading locations. Please try again.
      </div>
    );
  }
    ...
    return (
      <div className="flex flex-col items-center justify-center px-4 py-16 text-center">
        ...
        <p className="mt-3 max-w-lg font-ochre-ui text-sm leading-relaxed text-[#524439] md:text-base">
          Define storage locations across your facility so you can track
          inventory by warehouse, floor, room, and more.
        </p>
        <button
          type="button"
          onClick={onCreateFirst}
          className={cn(
            "mt-8 inline-flex items-center gap-2 rounded-md bg-[#894d0d] px-5 py-2.5 font-ochre-ui text-sm font-semibold text-white shadow-sm",
