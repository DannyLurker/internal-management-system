...
import { Boxes, Calendar, Check, Loader2, MapPin } from "lucide-react";
...
const stockTypeColors: Record<StockType, { bg: string; text: string; border: string }> = {
  READY: {
    bg: "bg-emerald-50",
...
export default function SearchStockDialog({
  ...
  }, [debouncedSearch, itemId, locationId, activeTypeFilter]);
                      ...
                      <div className="min-w-0 flex-1 space-y-1">
                        ...
                        <div className="flex flex-wrap items-center gap-3 text-xs text-[#524439]/75">
                          <span className="flex items-center gap-1">
                            ...
                            <span>{stock.location?.name ?? "Unassigned"}</span>
                          </span>
